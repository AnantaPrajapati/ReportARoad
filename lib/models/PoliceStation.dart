...
class PoliceStation extends StatefulWidget {
  @override
  State<PoliceStation> createState() => _ViewAddressPageState();
}

class _ViewAddressPageState extends State<PoliceStation> {
  ...
  Future<void> _fetchNearbyPoliceStations() async {
    Position position = await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high);
    final url =
        'https://map-places.p.rapidapi.com/nearbysearch/json?location=${position.latitude}%2C${position.longitude}&radius=1500&keyword=PoliceStation&type=PoliceStation';
